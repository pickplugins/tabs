=== Tabs & Accordion ===
	...
	Create  faq, tabs, tab content via shortcode and display anywhere under post, page or widget and page
	builder elements.
...
== Changelog ==
    ...
    * 2020-04-25 - add - hide for schema by section.
	...
	= 2.2.19 =
    * 2020-04-25 - fix - accordion shortcode "tabs_pplugins" back
    ...
    * 13-03-2020 - update - readmore text update
	...
	= 2.2.0 =
    * 13-03-2020 - add - tabs preview on frontend.
